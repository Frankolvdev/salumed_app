...
class SelectLocationWeb extends StatefulWidget {
  String defaultAddress;
  SelectLocationWeb({this.defaultAddress = ""});
  @override
  _SelectLocationWebState createState() => _SelectLocationWebState();
}

class _SelectLocationWebState extends State<SelectLocationWeb>
  ...
  void createMarkerSelectLocationWeb() {
    final provider = Provider.of<AppProvider>(context, listen: false);
    final Marker marker = Marker(
      ...
      draggable: false,
      icon: (kIsWeb) ? BitmapDescriptor.defaultMarker : provider.getFromIconPin,
      onTap: () {
        print("marker tap");
      },
    );
  ...
  void updatePositionMarker(CameraPosition _position) async {
    final provider = Provider.of<AppProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    Widget map = GoogleMap(
      ...
      onCameraIdle: (() {
        ...
        if (entryMap && showBtnConfirmLocationMap) {
          progressLocationMap();
        }
      }),
              ...
              child: Center(
                  child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Image.asset("assets/images/pin_from.png",
                            width: 30),
                      ))),
            ))
          ],
