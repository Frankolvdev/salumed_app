...
class LaboratoryAdminProfile extends StatefulWidget {
  const LaboratoryAdminProfile({Key? key}) : super(key: key);

  @override
  _LaboratoryAdminProfileState createState() => _LaboratoryAdminProfileState();
}

class _LaboratoryAdminProfileState extends State<LaboratoryAdminProfile> {
