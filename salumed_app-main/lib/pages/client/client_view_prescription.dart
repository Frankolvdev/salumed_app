...
class ClientViewPrescription extends StatefulWidget {
  PrescriptionModel prescription;
  Function callBackBack;
  ClientViewPrescription(this.callBackBack, this.prescription, {Key? key})
      : super(key: key);

  @override
  _ClientViewPrescriptionState createState() => _ClientViewPrescriptionState();
}

class _ClientViewPrescriptionState extends State<ClientViewPrescription> {
  final cDiagnosis = TextEditingController();
  final cEvolution = TextEditingController();
  final cPrescription = TextEditingController();
  final cDoctor = TextEditingController();
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      (widget.prescription.medicines != null &&
                              widget.prescription.medicines is List)
                          ? Column(
                              children: widget.prescription.medicines!
                                  .asMap()
                                  .entries
                                  .map((item) {
                                dynamic e = item.value;
                          ...
                          : Container(),
                      (checkEmpty(widget.prescription.prescription_text))
                          ? Padding(
                              padding:
                                  const EdgeInsets.symmetric(vertical: 8.0),
                      ...
                      //new
                      (widget.prescription.id_order != null)
                          ? Padding(
                              padding:
                          ...
                          : Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  processConfirm();
                                  /*setState(() {
                                    confirmPrescription = widget.prescription;
                                  });*/
                                },
                                child: Container(
                                  width: double.infinity,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Flexible(
                                        child: Text(
                                          "Solicitar medicamentos y generar pedido",
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 15.0),
                                          textAlign: TextAlign.center,
      ...
      simpleLoading(context, (BuildContext loadingContext) async {
        ...
        try {
          dynamic orderTmp = await WebService(context).createOrder(
              ...
              widget.prescription.patient!.id ?? "",
          ...
          SnackBar(
                  content: Text("Se ha creado su orden con éxito",
                      style: TextStyle(
                        color: Colors.white,
                      )),
                  elevation: 100,
