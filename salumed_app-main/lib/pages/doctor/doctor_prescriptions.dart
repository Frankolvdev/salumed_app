...
import 'package:app/pages/doctor/doctor_view_prescription.dart';
...
class DoctorPrescriptions extends StatefulWidget {
  const DoctorPrescriptions({Key? key}) : super(key: key);

  @override
  _DoctorPrescriptionsState createState() => _DoctorPrescriptionsState();
}
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: (pTmp.doctor!.picture != null &&
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text("Medicamentos solicitados",
                                            style: TextStyle(
                                                fontWeight: FontWeight.normal,
                                                color: Colors.white,
                                                fontSize: 14),
                            ...
                            child: Padding(
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (provider.user.verified_doctor == "no") {
