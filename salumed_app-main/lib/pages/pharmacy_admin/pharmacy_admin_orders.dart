...
class PharmacyAdminOrders extends StatefulWidget {
  const PharmacyAdminOrders({Key? key}) : super(key: key);

  @override
  State<PharmacyAdminOrders> createState() => _PharmacyAdminOrdersState();
}

class _PharmacyAdminOrdersState extends State<PharmacyAdminOrders>
      ...
      body: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            ...
            children: [
              PharmacyAdminOrders1(),
              PharmacyAdminOrders2(),
              PharmacyAdminOrders3(),
              PharmacyAdminOrders4()
            ],
          ),
        ),
      ),
