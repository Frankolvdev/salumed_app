...
class _StressScreenState extends State<StressScreen> {
  ...
  static const String _videoAsset = 'assets/video/stress.mp4';
  static const String _beachSoundAsset = 'sound/good_sleep_ambient.mp3';
  static const String _ttsSoundAsset = 'sound/stress.mp3';
  ...
  Future<void> _saveStartTime() async {
    ...
    await prefs.setString('stress_last_used', _startTime!.toIso8601String());
  }
  ...
  Future<void> _saveDuration() async {
    if (_startTime != null) {
      ...
      final prefs = await SharedPreferences.getInstance();
      await prefs.setInt('stress_duration', duration);
    }
  }
