...
class GoodSleepScreen extends StatefulWidget {
  const GoodSleepScreen({Key? key}) : super(key: key);

  @override
  State<GoodSleepScreen> createState() => _GoodSleepScreenState();
}

class _GoodSleepScreenState extends State<GoodSleepScreen> {
  ...
  static const String _videoAsset = 'assets/video/good_sleep.mp4';
  static const String _beachSoundAsset = 'sound/good_sleep_ambient.mp3';
  static const String _ttsSoundAsset = 'sound/good_sleep.mp3';
  ...
  Future<void> _saveStartTime() async {
    ...
    await prefs.setString('good_sleep_last_used', _startTime!.toIso8601String());
  }
  ...
  Future<void> _saveDuration() async {
    if (_startTime != null) {
      ...
      final prefs = await SharedPreferences.getInstance();
      await prefs.setInt('good_sleep_duration', duration);
    }
  }
