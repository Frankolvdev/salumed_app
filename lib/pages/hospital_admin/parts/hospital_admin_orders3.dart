...
class HospitalAdminOrders3 extends StatefulWidget {
  Function callBack;
  HospitalAdminOrders3(this.callBack, {Key? key}) : super(key: key);

  @override
  _HospitalAdminOrders3State createState() => _HospitalAdminOrders3State();
}

class _HospitalAdminOrders3State extends State<HospitalAdminOrders3> {
