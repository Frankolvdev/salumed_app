...
class HospitalAdminOrders4 extends StatefulWidget {
  Function callBack;
  HospitalAdminOrders4(this.callBack, {Key? key}) : super(key: key);

  @override
  _HospitalAdminOrders4State createState() => _HospitalAdminOrders4State();
}

class _HospitalAdminOrders4State extends State<HospitalAdminOrders4> {
  ...
  List<String> statuses = ["cancelled"];
  @override
  void initState() {
    super.initState();
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: (oTmp.prescription!.doctor != null &&
