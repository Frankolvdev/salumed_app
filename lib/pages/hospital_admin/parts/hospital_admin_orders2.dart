...
class HospitalAdminOrders2 extends StatefulWidget {
  Function callBack;
  HospitalAdminOrders2(this.callBack, {Key? key}) : super(key: key);

  @override
  _HospitalAdminOrders2State createState() => _HospitalAdminOrders2State();
}

class _HospitalAdminOrders2State extends State<HospitalAdminOrders2> {
