...
import 'package:app/pages/hospital_admin/hospital_admin_view_order.dart';
...
class HospitalAdminOrders1 extends StatefulWidget {
  Function callBack;
  HospitalAdminOrders1(this.callBack, {Key? key}) : super(key: key);

  @override
  _HospitalAdminOrders1State createState() => _HospitalAdminOrders1State();
}

class _HospitalAdminOrders1State extends State<HospitalAdminOrders1> {
  ...
  List<String> statuses = ["pendient", "budget_acceptance_pending"];
  @override
  void initState() {
    super.initState();
  ...
  Future<Null> loadMore() {
    ...
    return WebService(context)
        .getOrders(limit, orders.length, context, provider.user.token ?? "",
            search: cSearch.text,
  ...
  Future<Null> load() {
    final provider = Provider.of<AppProvider>(context, listen: false);
    return WebService(context)
        .getOrders(limit, 0, context, provider.user.token ?? "",
            search: cSearch.text,
            id_user: provider.user.id ?? "",
            statuses: statuses)
        .then((value) {
  ...
  Widget build(BuildContext context) {
    ...
    List<ResponsiveGridCol> progressWidgets =
      ...
      dynamic lastBudget = (getLastBudget(oTmp.budgets!));

      print("ESTE ES EL DOCTOR BUSCADO");
      print(oTmp.prescription!.doctor);
                    ...
                    child: Card(
                      ...
                      child: Column(
                        children: [
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: (oTmp.prescription!.doctor !=
                                                  null &&
                                              oTmp.prescription!.doctor!
                                                      .picture !=
                                                  null &&
                                              getImageUrl(oTmp.prescription!
                                                          .doctor!.picture!)
                                                      .trim() !=
                                                  "")
                                          ? ClipRRect(
                          ...
                          (lastBudget != null && lastBudget is BudgetModel)
                              ? Column(
                                  children: [
                                    (oTmp.type !=
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(getStatusPatient(oTmp),
                                              style: TextStyle(
                                                  fontWeight: FontWeight.normal,
                                                  color: Colors.white,
                                                  fontSize: 14),
