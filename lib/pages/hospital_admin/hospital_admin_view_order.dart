...
import 'package:app/pages/hospital_admin/hospital_admin_confirm_order.dart';
...
class HospitalAdminViewOrder extends StatefulWidget {
  Function callBackBack;
  OrderModel order;
  HospitalAdminViewOrder(this.callBackBack, this.order, {Key? key})
      : super(key: key);

  @override
  _HospitalAdminViewOrderState createState() => _HospitalAdminViewOrderState();
}

class _HospitalAdminViewOrderState extends State<HospitalAdminViewOrder> {
  ...
  Widget build(BuildContext context) {
    ...
    if (confirmPrescription != null && budgetSelected != null) {
      return HospitalAdminConfirmOrder((val) {
        setState(() {
    ...
    if (widget.order.type_delivery == "home") {
      ...
      return Stepper(
        ...
        steps: [
          ...
          Step(
            isActive: true,
            title: Text("Puedes pasar a recoger tu pedido"),
            content: Container(),
          ),
          Step(
            isActive: true,
    ...
    if (widget.order.type_delivery == "home") {
      ...
      return Stepper(
        ...
        steps: [
          ...
          Step(
            title: Text("Puedes pasar a recoger tu pedido"),
            content: Text("Preparando el paquete"),
          ),
          Step(
            title: Text("Tu pedido fue entregado"),
            content: Text(""),
