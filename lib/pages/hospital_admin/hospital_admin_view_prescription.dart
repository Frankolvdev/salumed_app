...
class HospitalAdminViewPrescription extends StatefulWidget {
  PrescriptionModel prescription;
  Function callBackBack;
  HospitalAdminViewPrescription(this.callBackBack, this.prescription,
      {Key? key})
      : super(key: key);

  @override
  _HospitalAdminViewPrescriptionState createState() =>
      _HospitalAdminViewPrescriptionState();
}

class _HospitalAdminViewPrescriptionState
    extends State<HospitalAdminViewPrescription> {
  ...
  void initState() {
    ...
    cDoctor.text = (prescription.doctor != null)
