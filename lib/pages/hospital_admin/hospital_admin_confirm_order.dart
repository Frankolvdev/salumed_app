...
class HospitalAdminConfirmOrder extends StatefulWidget {
  Function callBackBack;
  PrescriptionModel prescription;
  BudgetModel budgetAccepted;
  OrderModel order;
  HospitalAdminConfirmOrder(
      this.callBackBack, this.prescription, this.budgetAccepted, this.order,
      {Key? key})
      : super(key: key);

  @override
  _HospitalAdminConfirmOrderState createState() =>
      _HospitalAdminConfirmOrderState();
}

class _HospitalAdminConfirmOrderState extends State<HospitalAdminConfirmOrder> {
