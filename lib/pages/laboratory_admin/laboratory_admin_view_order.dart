...
class LaboratoryAdminViewOrder extends StatefulWidget {
  Function callBackBack;
  OrderModel order;
  LaboratoryAdminViewOrder(this.callBackBack, this.order, {Key? key})
      : super(key: key);

  @override
  _LaboratoryAdminViewOrderState createState() =>
      _LaboratoryAdminViewOrderState();
}

class _LaboratoryAdminViewOrderState extends State<LaboratoryAdminViewOrder> {
