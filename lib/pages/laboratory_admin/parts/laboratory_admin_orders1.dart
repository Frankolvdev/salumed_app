...
import 'package:app/pages/laboratory_admin/laboratory_admin_send_costs.dart';
...
class LaboratoryAdminOrders1 extends StatefulWidget {
  LaboratoryAdminOrders1({Key? key}) : super(key: key);

  @override
  _LaboratoryAdminOrders1State createState() => _LaboratoryAdminOrders1State();
}

class _LaboratoryAdminOrders1State extends State<LaboratoryAdminOrders1> {
  ...
  Widget build(BuildContext context) {
    ...
    if (sendCostsOrder != null) {
      return laboratoryAdminSendCosts(() {
        setState(() {
          sendCostsOrder = null;
        });
        WidgetsBinding.instance?.addPostFrameCallback((_) {
