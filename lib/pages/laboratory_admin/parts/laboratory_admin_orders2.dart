...
class LaboratoryAdminOrders2 extends StatefulWidget {
  LaboratoryAdminOrders2({Key? key}) : super(key: key);

  @override
  _LaboratoryAdminOrders2State createState() => _LaboratoryAdminOrders2State();
}

class _LaboratoryAdminOrders2State extends State<LaboratoryAdminOrders2> {
