...
class AdminEditLaboratory extends StatefulWidget {
  Function callBackBack;
  PharmacyModel pharmacy;
  AdminEditLaboratory(this.callBackBack, this.pharmacy, {Key? key})
      : super(key: key);

  @override
  _AdminEditLaboratoryState createState() => _AdminEditLaboratoryState();
}

class _AdminEditLaboratoryState extends State<AdminEditLaboratory> {
