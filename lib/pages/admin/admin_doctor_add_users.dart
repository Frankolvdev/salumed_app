...
class AdminDoctorAddUsers extends StatefulWidget {
  Function callBackBack;
  UserModel user;
  AdminDoctorAddUsers(this.callBackBack, this.user, {Key? key})
      : super(key: key);

  @override
  _AdminDoctorAddUsersState createState() => _AdminDoctorAddUsersState();
}

class _AdminDoctorAddUsersState extends State<AdminDoctorAddUsers> {
