...
class AdminSendCosts extends StatefulWidget {
  Function callBackBack;
  OrderModel order;
  AdminSendCosts(this.callBackBack, this.order, {Key? key}) : super(key: key);

  @override
  _AdminSendCostsState createState() => _AdminSendCostsState();
}

class _AdminSendCostsState extends State<AdminSendCosts> {
  ...
  Widget build(BuildContext context) {
    ...
    final drugCostField = TextFormField(
      ...
      //initialValue: Environment.localUsername(),
      decoration: InputDecoration(
        labelText: (widget.order.type != "studies_without_prescription")
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  (oTmp.type == "studies_without_prescription")
                                      ? InkWell(
                                          onTap: () {
                                            setState(() {
                                              showLabSt = !showLabSt;
    ...
    if (medicines.length <= 0) {
      ...
      showErrorsDialog(context, [
        (widget.order.type != "studies_without_prescription")
            ? "Debe agregar al menos 1  medicamento"
            : "Debe agregar al menos 1 estudio a la tabla de costos"
      ]);
      return flag;
    }
    medicines.forEach((row) {
