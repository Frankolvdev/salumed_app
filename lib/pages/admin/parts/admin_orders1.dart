...
import 'package:app/pages/admin/admin_send_costs.dart';
...
import 'package:app/pages/pharmacy_admin/pharmacy_admin_send_costs.dart';
...
class AdminOrders1 extends StatefulWidget {
  AdminOrders1({Key? key}) : super(key: key);

  @override
  _AdminOrders1State createState() => _AdminOrders1State();
}

class _AdminOrders1State extends State<AdminOrders1> {
  ...
  Widget build(BuildContext context) {
    ...
    if (sendCostsOrder != null) {
      return AdminSendCosts(() {
        setState(() {
          sendCostsOrder = null;
        });
        WidgetsBinding.instance?.addPostFrameCallback((_) {
    ...
    List<ResponsiveGridCol> progressWidgets =
      ...
      dynamic lastBudget =
          (getMyLastBudget(oTmp.budgets!, provider.user.pharmacy_assigned!));
                                          ...
                                          ? Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                      "Mi ultimo presupuesto (Con envio): " +
                                                          getTotalOrder(
                                                                  lastBudget)
                                                              .toString() +
                                                          " \$",
