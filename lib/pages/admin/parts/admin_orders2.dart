...
class AdminOrders2 extends StatefulWidget {
  AdminOrders2({Key? key}) : super(key: key);

  @override
  _AdminOrders2State createState() => _AdminOrders2State();
}

class _AdminOrders2State extends State<AdminOrders2> {
  ...
  void initState() {
    ...
    print("farmacia aaa");
    print(provider.user.pharmacy_assigned!.id ?? "");
  }
