...
class PharmacyAdminStatics extends StatefulWidget {
  const PharmacyAdminStatics({Key? key}) : super(key: key);

  @override
  State<PharmacyAdminStatics> createState() => _PharmacyAdminStaticsState();
}

class _PharmacyAdminStaticsState extends State<PharmacyAdminStatics> {
