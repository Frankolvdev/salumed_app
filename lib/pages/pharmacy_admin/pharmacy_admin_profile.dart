...
class PharmacyAdminProfile extends StatefulWidget {
  const PharmacyAdminProfile({Key? key}) : super(key: key);

  @override
  _PharmacyAdminProfileState createState() => _PharmacyAdminProfileState();
}

class _PharmacyAdminProfileState extends State<PharmacyAdminProfile> {
