...
class PharmacyAdminViewOrder extends StatefulWidget {
  Function callBackBack;
  OrderModel order;
  PharmacyAdminViewOrder(this.callBackBack, this.order, {Key? key})
      : super(key: key);

  @override
  _PharmacyAdminViewOrderState createState() => _PharmacyAdminViewOrderState();
}

class _PharmacyAdminViewOrderState extends State<PharmacyAdminViewOrder> {
