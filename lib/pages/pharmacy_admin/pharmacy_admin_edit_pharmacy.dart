...
class PharmacyAdminEditPharmacy extends StatefulWidget {
  PharmacyAdminEditPharmacy({Key? key}) : super(key: key);

  @override
  _PharmacyAdminEditPharmacyState createState() =>
      _PharmacyAdminEditPharmacyState();
}

class _PharmacyAdminEditPharmacyState extends State<PharmacyAdminEditPharmacy> {
