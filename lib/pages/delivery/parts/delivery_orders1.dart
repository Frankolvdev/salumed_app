...
import 'package:app/pages/delivery/delivery_view_order.dart';
...
class DeliveryOrders1 extends StatefulWidget {
  DeliveryOrders1({Key? key}) : super(key: key);

  @override
  _DeliveryOrders1State createState() => _DeliveryOrders1State();
}

class _DeliveryOrders1State extends State<DeliveryOrders1> {
  ...
  List<String> statuses = ["delivery_assigned", "go_deliver", "completed"];
  @override
  void initState() {
    super.initState();
