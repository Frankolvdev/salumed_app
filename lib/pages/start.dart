...
class _StartPageState extends State<StartPage>
    ...
    if (!kIsWeb) {
      ...
      OneSignal.Notifications.addClickListener((event) {
        ...
        if (additionalData != null &&
            additionalData.containsKey("notification")) {
  ...
  void registerPushId(BuildContext context) async {
    ...
    if (provider.user.one_signal_id == null ||
        provider.user.one_signal_id!.trim() != onesignalUserId) {
  ...
  Future<void> _loadDashboardData() async {
    ...
    final trainingType =
        prefs.getString('training_type') ??
        'gym'; // Default 'gym' si no seleccionado
    final trainingLevel = prefs.getString(
      'training_level',
    ); // Puede ser null si no seleccionado
        ...
        return Scaffold(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text(
                                "Salud y medicamentos al instante",
          ...
          floatingActionButton: Showcase(
            ...
            child: FloatingActionButton(
              ...
              child: Icon(
                isOpen ? Icons.close : Icons.lightbulb,
                color: Colors.white,
              ),
            ),
          ),
