...
class ClientPrescriptions extends StatefulWidget {
  Function callbackToOrders;
  ClientPrescriptions(this.callbackToOrders, {Key? key}) : super(key: key);

  @override
  _ClientPrescriptionsState createState() => _ClientPrescriptionsState();
}

class _ClientPrescriptionsState extends State<ClientPrescriptions> {
  ...
  Widget build(BuildContext context) {
    ...
    if (viewPrescription != null) {
      return ClientViewPrescription((val) {
